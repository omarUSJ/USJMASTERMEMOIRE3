...
jQuery(document).ready(function() {
    ...
    */
	...
	$('.home-top-content').backstretch(contextpath+"assets/img/backgrounds/1.jpg");
    $('.section-4-container').backstretch(contextpath+"assets/img/backgrounds/2.jpg");
    $('.section-6-container').backstretch(contextpath+"assets/img/backgrounds/1.jpg");
